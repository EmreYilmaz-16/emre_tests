...
<cfform method="post" action="#request.self#?fuseaction=#attributes.fuseaction#&id=#attributes.ID#">
  ...
  <div class="form-group">
    ...
    <input type="text" name="Tanim" value="">
  </div>
  <div class="form-group">
    <label>Tanım 2</label>
    <input type="text" name="Breadcrumb" value="">
  </div>
  <div class="form-group">
    <label>İçerik</label>
  ...
  <div class="form-group">
    ...
    <input type="text" name="SeoAnahtarKelime" value="">
  </div>
  <div class="form-group">
    <label>Seo Sayfa Açıklama</label>
    <textarea name="SeoSayfaAciklama"></textarea>
  </div>
  <div class="form-group">
    <label>Seo Sayfa Başlık</label>
    <input type="text" name="SeoSayfaBaslik" value="">
